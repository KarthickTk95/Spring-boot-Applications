...
public class EUSummaryRepositoryDao implements EURepository {
		...
		public List<DeviceModel> getAllDeviceSummary(String instance) {
			...
			//for(int i=0;i<instance.length;i++) {
				...
				return jdbcTemplate.query("select  count(*) as Total,\r\n"
						...
						+ "(select count(*) from "+instance+".deviceStatus where  deviceTimeStamp is null and sensorName not in('QR-Janitor','QR-Feedback','BLEGateWay')) as NotYetReporting,\r\n"
						...
						+ " from "+instance+".deviceStatus where sensorName not in('QR-Janitor','QR-Feedback','BLEGateWay');", new RowMapper<DeviceModel>() {
